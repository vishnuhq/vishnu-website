...
// Text content for about page hero
// Line 1: "Vishnu Vardhan Putta" - each word separate to prevent breaking
const nameWords = ['Vishnu', 'Vardhan', 'Putta'];

// Line 2: "A little more about me" - each word separate, "me" highlighted
const taglineWords = ['A', 'little', 'more', 'about'];
const taglineHighlight = 'me';
  ...
  return (
    <div className="flex flex-nowrap">
      {word.split('').map((letter, i) => (
        <div
          key={i}
          className={`about-letter font-semibold ${colorClass} ${sizeClass} leading-none`}
 ...
 * AboutHero
 *
 * Full-screen hero for the about page with GSAP-driven letter collision
 * animation. Letters scatter on scroll with per-character speed and rotation.
 */
export function AboutHero() {
  ...
  return (
    <div ref={containerRef} className="h-screen overflow-hidden bg-background">
      <h1 className="sr-only">Vishnu Vardhan Putta - A little more about me</h1>
      <div aria-hidden="true" className="flex h-full flex-col items-center justify-center gap-4 px-4 sm:gap-6 sm:px-8">
        ...
        {/* Line 2: A little more about me (can wrap, "me" in teal) */}
